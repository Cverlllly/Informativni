...
<body class="bg">
    <div class=container>
        <div><img class="box" src="https://ssgo.scv.si/wp-content/themes/yoo_master2_wp/images/ssgo.svg" alt="IMG SSGO" width="130" height="130" onclick="location.href='login.php?sola=ssgo';"></div>
        ...
        <div><img class="box" src="slike/scv.png" alt="IMG SSGO" onclick="location.href='login.php?sola=vse';"></div>
    </div>
</body>
